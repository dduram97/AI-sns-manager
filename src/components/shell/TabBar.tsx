...
export function TabBar() {
  ...
  return (
    <nav
      className={cn(
        // PC: AppSidebar replaces bottom tabs
        "fixed inset-x-0 bottom-0 z-40 border-t border-border/80 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 md:hidden",
      )}
    >
